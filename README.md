...
O projeto simula a atuação de uma agência de tecnologia, integrando design (UX/UI), identidade visual e planejamento de interface, com foco em uma página única, limpa, funcional e atrativa.
...
Planejar a estrutura de uma Landing Page para um parque temático

Aplicar conceitos de UX/UI, hierarquia visual e usabilidade

Criar uma identidade visual coerente com um parque de alto padrão

Traduzir emoção, entretenimento e cinema em uma experiência digital
...
Ilha dos Dinossauros (aventura)

Galáxia Espacial (ficção científica)

Universo dos Heróis (ação)

Reino da Animação (família)

Terror & Suspense (experiência com restrição de idade)
...
Dourado Metálico #C9A24D – logotipo, botões e detalhes

Branco Suave #F5F5F5 – textos

Vermelho Vinho #7A1F2B – destaques e interações
